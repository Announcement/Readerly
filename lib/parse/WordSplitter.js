	...
	*/
		...
		*/
		...
		rSpt._splitWord = function(chars, maxChars) {
		    ...
		    let specialCharacters = chars.match(/[\x21-\x2F\x3A-\x40\x5B-\x60\x7B-\x7E]/g);
		    let specialCharacterCount = specialCharacters != null ? specialCharacters.length : 0;
		    let hasSpace = chars.includes(" ");

		    if ((hasSpace || (specialCharacterCount / chars.length) > 0.20) && !chars.match(/([a-zA-Z]|[ά-ωΑ-ώ])[-]([a-zA-Z]|[ά-ωΑ-ώ])/g) || chars.match(/([a-zA-Z]|[ά-ωΑ-ώ])+[.]([a-zA-Z]|[ά-ωΑ-ώ])+[.]([a-zA-Z]|[ά-ωΑ-ώ])+[;]/g)) {
		        return [chars];
		    }
