...
var Parser = function Parser(_ref) {
  var cleanNode = _ref.cleanNode,
      detectLanguage = _ref.detectLanguage,
      findArticle = _ref.findArticle,
      cleanText = _ref.cleanText,
      splitSentences = _ref.splitSentences;
  ...
  rPar.parse = function (input) {
    if (Array.isArray(input)) {
      ...
      }).reduce(function (combined, array) {
