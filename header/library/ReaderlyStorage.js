...
var ReaderlyStorage = function ReaderlyStorage() {
  ...
  */
  ...
  rSto.get = function (keyOrKeys, callback) {
    chrome.storage.local.get(keyOrKeys, function loadOldReaderlySettings(settings) {
      callback(settings);
    });
  }; // End rSto.get()
...
exports.default = ReaderlyStorage;
