...
var nouiCSSstr
;($ = require('jquery')),
  (coreCSSstr = require('./core-CSS')),
  (nouiCSSstr = require('./settings/noui-CSS'))

// ;(function(root, displayFactory) {
//   // root is usually `window`
//   if (typeof define === 'function' && define.amd) {
//     // AMD. Register as an anonymous module.
//     define(['jquery', 'core-CSS', 'settings/noui-CSS'], function(
//       jquery,
//       nouiCSS
//     ) {
